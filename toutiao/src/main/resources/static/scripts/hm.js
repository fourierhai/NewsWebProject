(function () {
    ...
    (function () {
        ...
        var b = mt.url, f = mt.O, d = mt.P, e = mt.lang, m = mt.cookie, n = mt.j, g = mt.localStorage,
            k = mt.sessionStorage, l = h.w, v = h.G;
        a.prototype = {
            K: function (a, b) {
                a = "." + a.replace(/:\d+/, "");
                b = "." + b.replace(/:\d+/, "");
                ...
                var a = document.location.hash.substring(1), d = RegExp(c.id), e = -1 < document.referrer.indexOf(l.ba),
                    f = b.k(a, "jn"), g = /^heatlink$|^select$/.test(f);
    ...
    (function () {
        ...
        if ("undefined" !== typeof h.b && (c.med || (!a.T || 7 < a.ya) && c.cvcc)) {
            var e, m, n, g, k = function (a) {
                ...
                g.v = a;
                if (f) {
                    var m = f.getAttribute("href"), k = f.getAttribute("onclick") ? "" + f.getAttribute("onclick") : t,
                        l = f.getAttribute("id") || "";
